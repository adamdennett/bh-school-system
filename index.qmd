...
ggplot(cv, aes(x, y, colour = design)) +
  ...
  labs(x = "Cumulative share of all households with dependent children",
       ...
       subtitle = str_wrap(paste("The dashed line is a perfectly even spread.", "The marked points are the most and least even designs, at their widest gap from it - the dissimilarity index."), 100),
       caption = "Sources: ONS postcode household counts; IMD 2019 IDACI.") +
  theme_bh(11) +
