...
```{r tbl-weigh-2030}
#| tbl-cap: "The options in 2030, under the council's priorities. Community schools' balance is the steady-state annual balance across the six schools the council runs (section 6). Gorard is across all city schools' intakes. The deprived-journey gap is the extra minutes children from the three most deprived deciles travel. Displaced children would have taken a place in their own catchment and could not. Where an option cuts a school's admission number and that school is no longer full in 2030, the cut changes nothing that year."
...
- **Whitehawk back in Longhill's catchment** adds
  ...
  gain as the cohort falls. It barely changes journeys and, as
  Priorities 2 and 3 show, it helps on both.
...
**Whitehawk back to Longhill lowers segregation more than any other
option the council controls**, to
`r sprintf("%.3f", co("whitehawk", "gorard"))`, without lengthening
anyone's journey materially --- and it holds that in 2035
(`r sprintf("%.3f", co("whitehawk", "gorard", 2035))`).

**Priority 6 works against it.** Switched off, the index is
...
- *Whitehawk back to Longhill* helps all three: more children for
  Longhill, the largest fall in segregation the council can make, less
  displacement, and no real change to journeys.
...
- *Access against segregation.* Elm Grove and CoMArt shorten deprived
  children's journeys and concentrate them in one school. If the council
...
1. **Return Whitehawk to Longhill's catchment** for the next admissions
   round. It is the one change that serves every priority.
...
5. **Review priority 6** in the light of what it does to segregation,
   and publish where its places went.
