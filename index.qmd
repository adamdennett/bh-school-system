...
**The basemaps are CARTO's.** Every map in this document carries the
CARTO and OpenStreetMap attribution in its corner, which is the
condition of the free tier, and `R/99_verify_render.R` fails the build
if a map loses it.
