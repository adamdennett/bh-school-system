...
| Who is modelled | Brighton & Hove children, and the ten city schools as destinations | Cohort estimates from section 3 | Children leaving for Peacehaven, independent schools or elsewhere are not modelled, so every school's intake is slightly high. The simulator shows an estimate of them beside the model --- the adjudicator's published count of children offered a place outside the city, by catchment, a three-round mean scaled with the cohort --- and takes it out of the children the model places at another city school. |
