...
| Who is modelled | Brighton & Hove children, and the ten city schools as destinations | Cohort estimates from section 3 | Some children do leave the city --- to schools such as Priory School in Lewes, as well as to Peacehaven and independent schools --- about 70 a year, three in four of them from Longhill's catchment. The model's destinations are the city schools, so those children are not routed to a school outside it and every city school's intake is slightly high. The simulator shows them beside the model instead: the adjudicator's published count of children offered a place outside the city, by catchment, a three-round mean scaled with the cohort, taken out of the children the model places at another city school. |
...
- **Moving with redrawn catchments roughly breaks even**: `r fmt_n(m5n("E", 2030))` in 2030 against `r fmt_n(m5n("B", 2030))` staying put. The redraw wins back what the move lost.
