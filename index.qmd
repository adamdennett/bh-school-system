...
families ask for --- and then applies the capacity ceiling exactly as M2
does.
...
#### Attractiveness balanced to what families ask for
...
| Who is modelled | Brighton & Hove children, and the ten city schools as destinations | Cohort estimates from section 3 | Children leaving for Peacehaven, independent schools or elsewhere are not modelled, so every school's intake is slightly high. |
...
| Capacity | A one-sided ceiling by iterative proportional fitting | Admission numbers in force | Applicants to a full school are cut back in proportion, which is what a random tie-break averages to --- and the council breaks ties at random. |
