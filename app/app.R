...
server <- function(input, output, session) {
  ...
  output$fair_note <- renderUI({
    ...
    HTML(paste0(
      live,
      "<p><b>How segregation is measured.</b> The index counts disadvantaged pupils. Each ",
      "school's pull on disadvantaged children is fitted, on today's map and the council's ",
      "priorities, to the first Year 7 intakes admitted under them: for the six community ",
      "schools, the share of their September 2026 offers that went to children eligible for ",
      "free school meals, from the council's allocation factsheet; for the four academies and ",
      "faith schools, whose arrangements did not change, the Department for Education's ",
      "published share of disadvantaged pupils. The pulls are then held fixed while maps, ",
      "places and schools change. The published whole-school figures on their own lag the ",
      "policy by up to five years, which is why they are not used for the community schools. ",
      "An earlier version scored intakes by the neighbourhoods their ",
      "children came from, and that put the schools in the wrong order: Longhill and Hove ",
      "Park, among the most disadvantaged intakes in the published figures, came out among ",
      "the least. See section 11 of the strategic view.</p>",
      "<p><b>Priority 6.</b> On the calibrated measure the priority-6 share makes no ",
      "measurable difference to how mixed the intakes are. The line above gives it for the ",
      "settings on screen. Closing or moving a school does far more.</p>",
      "<p>This is a model result, not an observed one. The council has not published which ",
      "neighbourhoods priority-6 places went to, and a school's pull on disadvantaged ",
      "children is fitted to its published share, not measured directly.</p>"))
  })
